...
then
	...
	export PATH=$PATH:export PATH=$PATH:/opt/freescale/usr/local/gcc-4.6.2-glibc-2.13-linaro-multilib-2011.12/fsl-linaro-toolchain/bin
fi
make distclean
make mx6d_icore_config	
echo u-boot-icore-dual > icore_config
make
