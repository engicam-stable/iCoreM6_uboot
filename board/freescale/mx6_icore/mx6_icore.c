...
//	MX6Q_PAD_RGMII_TX_CTL__ANATOP_REF_OUT 	,
...
//	MX6Q_PAD_GPIO_3__CCM_CLKO2 | MUX_PAD_CTRL(ENET_PAD_CTRL), /* to be removed */
//	MX6Q_PAD_ENET_REF_CLK__ENET_TX_CLK	| MUX_PAD_CTRL(ENET_PAD_CTRL),
#elif defined CONFIG_MX6DL
	MX6DL_PAD_ENET_CRS_DV__ENET_RX_EN 	,
//	MX6DL_PAD_RGMII_TX_CTL__ANATOP_REF_OUT 	,
...
//	MX6DL_PAD_GPIO_3__CCM_CLKO2 | MUX_PAD_CTRL(ENET_PAD_CTRL), /* to be removed */
...
void enet_board_init(void)
{
	...
	/* Reset PHY */
	set_gpio_output_val(GPIO7_BASE_ADDR, (1 << 12), 0);
	udelay(1000 * 10);
	set_gpio_output_val(GPIO7_BASE_ADDR, (1 << 12), 1);
...
int checkboard(void)
{
	...
	printf("Board: MX6Q-i.Core:[ ");
#elif defined CONFIG_ICORE_DUAL
	printf("Board: MX6D-i.Core:[ ");
#elif defined CONFIG_ICORE_SOLO
	printf("Board: MX6S-i.Core:[ ");
#endif
